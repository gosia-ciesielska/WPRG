<form class="booking-form" action="#" method="post">
  <div class="elem-group">
    ...
    if (isset($_COOKIE["username"])) {
      echo "<div class=\"elem-group\"><h1>Witaj, ".$_COOKIE["username"]."!</h1></div>";
    }
    ?>
  </div>
  <div class="elem-group">
  ...
  <div class="elem-group">
    ...
    value="<?php echo getReservationData($data, "name");?>" required>
    <?php
  ...
  <div class="elem-group">
    ...
    value="<?php echo getReservationData($data, "surname"); ?>" required>
    <?php
  ...
  <div class="elem-group">
    ...
    <input type="email" id="email" name="email" placeholder="jan.kowalski@gmail.com"
      value="<?php echo getReservationData($data, "email"); ?>" required>
    <?php
  ...
  <div class="elem-group">
    ...
    <input type="tel" id="phone" name="phone" placeholder="123256789" 
    value="<?php echo getReservationData($data, "phone"); ?>" required>
    <?php
  ...
  <div class="elem-group">
    ...
    <select id="guest-count" name="guest_count" autocomplete="off" required>
      ...
      <?php
      for ($i = 1; $i <= 4; $i++) {
        if (getReservationData($data, "guestCount") == $i) {
  ...
  <div class="elem-group inlined">
    ...
    value="<?php echo getReservationData($data, "checkInDate"); ?>" required>
    <?php
  ...
  <div class="elem-group inlined">
    ...
    value="<?php echo getReservationData($data, "checkOutDate"); ?>" required>
    <?php
  ...
  <fieldset>
    ...
    <div class="elem-group">
      ...
      <?php echo getReservationData($data, "kid") ? 'checked' : ''; ?>>
      <label for="kid">Łóżko dla dziecka</label>
    </div>
    <div class="elem-group">
      <input type="checkbox" id="ac" name="ac" 
      <?php echo getReservationData($data, "ac") ? 'checked' : ''; ?>>
      <label for="ac">Klimatyzacja</label>
    </div>
    <div class="elem-group">
      <input type="checkbox" id="pet" name="pet" 
      <?php echo getReservationData($data, "pet") ? 'checked' : ''; ?>>
  ...
  <div class="elem-group">
    ...
    <textarea id="notes" name="guest_notes" placeholder="Dodatkowe informacje dla obsługi"
      value="<?php echo getReservationData($data, "notes"); ?>"></textarea>
  </div>
